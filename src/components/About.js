      ...
      >
        ...
        <Grid item lg={9} xl={10}>
          <h5 className="text-gray-400 text-left wow fadeIn">
            ...
            been living in Norway. In September 2018 I moved to London to study.
            Before I came to the UK I graduated high school with a diploma in
            general studies, as well as electronics and electrical engineering.
            I am currently working as an intern software engineer for{' '}
          ...
          <h5 className="text-gray-400 text-left wow fadeIn">
            ...
            on, doubles as my photographic portfolio.
            <br />
            In the <Link to="/photogallery">gallery</Link> section, you can view
            some of my shots and download them!
          </h5>
          <br />
          <h5 className="text-gray-400 text-left wow fadeIn">
